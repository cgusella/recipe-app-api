...
def image_upload_url(recipe_id):
    """Return urls recipe image upload"""
...
class PublicRecipeApiTest(TestCase):
    """Test an unauthenticaed recipe API access"""

    def setUp(self):
        self.cline = APIClient()
...
class RecipeImageUploadTest(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as ntf:
            img = Image.new('RGB', (10, 10))  # 10 pixel x 10 pixel
    ...
    def test_filter_recipes_by_ingredient(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Posh beab on toast')
